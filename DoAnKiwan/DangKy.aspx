					...
					<div class="account-list-outer">
						...
						<div class="checkout-content">
							...
							<div class="form-horizontal">
                                ...
                                <div class="control-group">
								    <label class="control-label">Mật khẩu: <span class="text-error">*</span></label>
								    <div class="controls">
                                        <asp:TextBox ID="txtPass" runat="server" 
                                            placeholder="Nhập mật khẩu" Width="250px" TextMode="Password"></asp:TextBox>
								    </div>
								</div><!--end control-group-->
								<div class="control-group">
								    <label class="control-label">Xác nhận mật khẩu: <span class="text-error">*</span></label>
								    <div class="controls">
                                        <asp:TextBox ID="txtCheckpass" runat="server" 
                                            placeholder="Xác nhận lại mật khẩu" Width="250px" TextMode="Password"></asp:TextBox>
								    </div>
								</div><!--end control-group-->
                                ...
                                <div class="control-group">
							        ...
							        <div class="controls">
                                        <asp:Button ID="btnOK" runat="server" class="btn btn-primary" Text="Đăng ký" 
                                            onclick="btnOK_Click" />
